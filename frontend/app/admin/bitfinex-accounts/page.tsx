...
import BitfinexAccountsDashboard from "./BitfinexAccountsDashboard";
...
export default async function AdminBitfinexAccountsPage() {
  ...
  return <BitfinexAccountsDashboard initial={initial} />;
}
